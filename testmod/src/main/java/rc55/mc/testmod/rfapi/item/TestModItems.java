...
public class TestModItems {
    ...
    public static final BucketItem WOODEN_BUCKET = BucketItemRegistry.registerEmpty(new Identifier(MODID, "wooden_bucket"), 400, new Item.Settings());
    ...
    // Will throw IllegalArgumentException, temperature too high
    //public static final BucketItem WOODEN_STEAM_BUCKET = BucketItemRegistry.register(new Identifier(MODID, "wooden_bucket/steam"), WOODEN_BUCKET, TestModFluids.STEAM, new Item.Settings());
    ...
    public static final Map<DyeColor, ExtendedBucketItem> CERAMIC_DYE_BUCKETS = TestModMain.mapOf(DyeColor.class, color -> BucketItemRegistry.register(
            Identifier.of(MODID, "ceramic_bucket/%s_dye".formatted(color.getName())),
            CERAMIC_BUCKET,
            TestModFluids.DYE_FLUIDS.get(color),
            new Item.Settings().maxCount(16)
    ));
