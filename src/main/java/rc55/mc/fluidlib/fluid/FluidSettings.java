...
public class FluidSettings implements FluidVariantAttributeHandler {
    ...
    private static FluidSettings fromFabricVariant(FluidVariant fluidVariant) {
        ...
        if (fabricAttribute == null) {
            FluidLib.LOGGER.error("Fluid {} has neither fabric/fluidlib settings(aka property) defined!", FluidRegistry.getId(fluid));
     ...
     * @see rc55.mc.fluidlib.mixin.EntityMixin
     */
    ...
    public record ColorSettings(
         ...
         * Applied via {@linkplain rc55.mc.fluidlib.mixin.client.BackgroundRendererMixin mixins}
         */
