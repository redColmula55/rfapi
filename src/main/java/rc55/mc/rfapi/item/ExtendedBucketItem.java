...
public class ExtendedBucketItem extends BucketItem {
    ...
    public static int getMaxTemperature(ItemStack stack) {
        return getMaxTemperature(stack.getItem());
    }

    public static int getMaxTemperature(Item item) {
    ...
    public Text getName() {
        if (this.isEmpty()) {
            ...
            return Text.translatable(this.getBaseTranslationKey(), Text.translatable(this.getContextTranslationKey()));
        }
    }
     ...
     * @see #getName() How the format works
     */
    public String getBaseTranslationKey() {
        if (this.baseTranslationKey == null) {
            if (this.isEmpty()) {
                this.baseTranslationKey = this.getTranslationKey();
            } else {
                this.baseTranslationKey = this.getBaseItem().getTranslationKey() + ".filled";
            }
        }
